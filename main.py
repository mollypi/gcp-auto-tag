...
def tag_instance(instance: str, project: str, zone: str, creator_email: str):
    ...
    instance_labels = {'labels': {'created-by': creator_email}, 'labelFingerprint': instance_fingerprint}
...
def tag_disks(disks_list: list, project: str, zone: str, instance_name, creator_email: str):
